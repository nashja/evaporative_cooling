...
class EvaporativeCoolingApiClientError(Exception):
    """Exception to indicate a general API error."""


class EvaporativeCoolingApiClientCommunicationError(
    EvaporativeCoolingApiClientError,
):
    """Exception to indicate a communication error."""


class EvaporativeCoolingApiClientAuthenticationError(
    EvaporativeCoolingApiClientError,
):
